...
CREATE TABLE appointment (
  ...
  stu_id int(11) DEFAULT NULL COMMENT '咨询者id',
  doctor_id int(11) DEFAULT NULL COMMENT '医生id',
  dates varchar(20) DEFAULT NULL COMMENT '预约日期',
  times varchar(20) DEFAULT NULL COMMENT '预约时间',
...
(4,12,4,'2021-04-14','16:00-18:00','咨询者测试预约功能test3',0,NULL,1618228835088),
(5,12,2,'2021-04-14','14:00-16:00','test',0,NULL,1618241863897),
(6,13,1,'2021-05-08','10:00-12:00','咨询者测试提问题功能test1',2,'撒旦法分为',1620355919636),
...
CREATE TABLE ask_and_answer (
  ...
  stu_id int(11) DEFAULT NULL COMMENT '咨询者id',
  doctor_id int(11) DEFAULT NULL COMMENT '心理医生id',
...
(1,1,10,1,'咨询者侧聊天测试','2021-03-25 00:00:00'),
...
(6,1,11,0,'<img src=\"http://localhost:8080/psych/assets/chat/layui/images/face/1.gif\" alt=\"[嘻嘻]\">','2021-03-25 00:00:00'),
(7,1,11,0,'时间标签测试','2021-03-25 00:00:00'),
(8,1,11,0,'时间标签测试test2','2021-03-25 09:12:08'),
(9,1,11,0,'<img src=\"http://localhost:8080/psych/assets/chat/layui/images/face/2.gif\" alt=\"[哈哈]\">','2021-03-25 09:12:57'),
(10,1,12,0,'测试在线聊天','2021-03-28 09:25:41'),
(11,12,1,0,'<img src=\"http://localhost:8080/psych/assets/chat/layui/images/face/1.gif\" alt=\"[嘻嘻]\">','2021-03-29 07:16:27'),
(12,1,12,0,'<p>第二次测试聊天功能</p>','2021-04-01 15:11:58'),
(13,12,1,0,'嘿嘿嘿','2021-04-12 15:41:14'),
(14,13,1,0,'<img src=\"http://localhost:8080/psych/assets/chat/layui/images/face/1.gif\" alt=\"[嘻嘻]\">','2021-05-07 02:56:03'),
(15,13,1,0,'<img src=\"http://localhost:8080/psych/assets/chat/layui/images/face/2.gif\" alt=\"[哈哈]\">','2021-05-07 02:56:35');
...
(1,'0420210323','张海峰',0,32,4,'重庆大学','15043912738','23456434@qq.com','123456',1,1616513880781,NULL),
...
(5,'咨询者测试提问题功能test1',15,0,0,1,1616923253918,1617083261081),
(6,'咨询者测试提问题功能test2',5,0,0,0,1616930997215,1616934617160),
(7,'测试提问',1,0,0,1,1617937455821,1617937562378),
(8,'咨询者测试提问题功能test1',0,0,0,0,1620355960712,1620355960712);
...
CREATE TABLE user_auth_code (
  ...
  role_type int(11) NOT NULL COMMENT '用户类型1:医生 2:咨询者',
  code varchar(10) NOT NULL,
  use_status int(2) NOT NULL default 0 COMMENT '使用状态0:未使用 1:已使用',
