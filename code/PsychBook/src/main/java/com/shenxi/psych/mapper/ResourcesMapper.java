...
import com.shenxi.psych.entity.DocumentsAndTag;
...
public interface ResourcesMapper {
    ...
    @Results({
            ...
            @Result(column = "id",property = "documentsAndTags",many = @Many(select = "com.shenxi.psych.mapper.ResourcesMapper.getDocumentsAndTagByDocumentId",fetchType=FetchType.DEFAULT)),
    })
